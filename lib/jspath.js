...
var translate = (function() {
    ...
    TranslateResult.prototype.acquireVar = function() {
    ...
    TranslateResult.prototype.acquireLabel = function() {
        return 'lbl' + ++this._lastLabelId;
    };
    TranslateResult.prototype.releaseVars = function() {
        for (var i = 0, l = arguments.length; i < l; i++) {
            this._unusedVars.push(arguments[i]);
        }
    };
    TranslateResult.prototype.write = function() {
        var str = [];
        for (var i = 0, l = this._indent; i < l; i++) {
            str.push('  ');
        }
        str.push(Array.prototype.join.call(arguments, ''));
        this.body.push(str.join(''));
    };
    TranslateResult.prototype.indent = function() {
        this._indent++;
    };
    TranslateResult.prototype.unindent = function() {
        this._indent--;
    };
...
exports.apply = function(path, ctx, substs) {
    return (cache[path] || (cache[path] = build(path)))(ctx, substs || {});
};
