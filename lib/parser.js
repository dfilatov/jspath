  ...
  var result = {
    ...
    parse: function(input, startRule) {
      var parseFunctions = {
        ...
        "bracketsExpr": parse_bracketsExpr,
      ...
      function parse_operatorExpr() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, left, binaryOperator, right) {
                return function(ctx) {
